...
public:
    ...
    static void _limeAssert(
        std::string descr, bool assertion, const char* file, int line
    );
...
#define limeAssertDesc(DESC,X) {LimeError::_limeAssert((DESC),(X),__FILE__,__LINE__);}
